...
class GenerateMakefileCommand extends AbstractCommand
{
    /**
    ...
    {
        $this->setName('generate-makefile')
            ->setDescription('Generate Makefile for use with GNU make')
             ->setDefinition(
                 [
                     new InputArgument(
                         'build-xml',
                         InputArgument::REQUIRED,
                         'Path to GNU make Makefile that should be generated'
                     ),
                     new InputArgument(
                         'test-list-xml',
                         InputArgument::REQUIRED,
